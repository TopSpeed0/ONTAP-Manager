...
|-----------|------|----------|---------|-------------|
| `-SrcCluster` | string | No | `NDMP_Config.SrcCluster` | Source cluster Alias or cluster name |
| `-DstCluster` | string | No | `NDMP_Config.DstCluster` | Destination cluster Alias or cluster name |
...
3. Resolves source and destination clusters via `Find-ClusterConfig` (matches Alias or cluster)
